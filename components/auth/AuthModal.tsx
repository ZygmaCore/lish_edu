  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        setError('Invalid credentials. Try admin@lishedu.com / admin123 or user@example.com / user123');
      }
    } catch (err) {
      ...
      <div className="relative glassmorphism rounded-2xl p-8 w-full max-w-md shadow-2xl">
        ...
        {mode === 'login' && (
          <div className="mt-4 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
            ...
            <p className="text-xs text-gray-400">Admin: admin@lishedu.com / admin123</p>
